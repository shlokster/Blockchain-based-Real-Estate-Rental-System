        ...
        return (
          <div className="min-h-full d-flex justify-content-center align-items-center ">
            <div className="w-full border-none rounded-2xl p-2 relative bg-white h-full">
              <div className="h-24">
                <img
                  src="https://img.freepik.com/free-photo/vivid-blurred-colorful-background_58702-2655.jpg?w=1800&t=st=1699555170~exp=1699555770~hmac=a6e8fd8fe6b8d40c595680fd6aa28f7eb68cb7a51ec096b4e1049ed7adbbde8b"
              ...
              <div className=" flex justify-center relative text-center">
                <div className="flex justify-center border-3 border-solid  bg-white top-8 h-48 w-48 rounded-full">
                  <img
                    src="https://previews.123rf.com/images/girindra09/girindra091608/girindra09160800001/61726292-flat-fox-vector-for-mascot-and-avatar.jpg"
