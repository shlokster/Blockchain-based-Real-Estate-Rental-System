    ...
    <nav className="flex filter drop-shadow-md bg-white px-4 py-4 h-20 items-center z-50 w-full">
      ...
      <div className="w-3/12 flex items-center">
        <a className="w-20" href="/">
          <img
            src="https://www.codester.com/static/uploads/items/000/001/1738/preview.jpg"
            alt=""
          />
        </a>
      </div>
      <div className="w-9/12 flex justify-end items-center">
        ...
        <div className="hidden md:flex items-center justify-center ">
          ...
          >
            <NavLink to="/realestate">Search Real Estate</NavLink>
          </div>
          {web3Provider == null || address === [] ? (
            ...
            <div className="flex">
              ...
              >
                <NavLink to="/mint-realestate">Create Property</NavLink>
              </div>
              <span
                className={
